  ...
  return (
    <div className="h-full w-[25%] p-2 flex-col gap-2 text-white hidden lg:flex">
      ...
      <div className="h-[85%] bg-[#121212] rounded">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justfy-start gap-1 pl-4">
          <h1>Create your first playlist</h1>
          <p className="font-light">It's easy we will help you</p>
          <button className="px-4 py-1.5 bg-white text-black rounded-full text-[15px] mt-4">Create your playlist</button>
        </div>
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justfy-start gap-1 pl-4 mt-4">
